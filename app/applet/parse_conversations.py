...
parsed = parse_text(prompt_text)
print(f"Successfully parsed {len(parsed)} topics!")
for t in parsed[:3]:
    print(t["topic_num"], t["title"], "Basic len:", len(t["basic"]), "Inter len:", len(t["intermediate"]), "Adv len:", len(t["advanced"]))
